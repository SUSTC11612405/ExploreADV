...
if __name__ == '__main__':
    ...
    # path_model = './models/mnist_convSmallRELU.onnx'  # 0.9825
    dataset = 'cifar10'
    path_model = "../models/cifar10_relu_6_500.onnx"  # 0.5598
    # path_model = "./models/cifar10_convMedGSIGMOID.onnx"  # 0.5495
    path_model = "../models/cifar10_convBigRELU_DiffAI.onnx"  # 0.5144
    # path_model = "./models/cifar10_ResNet18_PGD.onnx"  # 0.8152
    # dataset = 'stl10'  # 0.772
    n_examples = 100
